...
@Component({
  selector: 'app-cadastrobolao',
  templateUrl: './cadastrobolao.component.html',
  styleUrls: ['./cadastrobolao.component.css']
})
export class CadastrobolaoComponent {
  ...
  public gravar() {
    ...
    if (this.mobile == true) {
      ...
      if ((document.getElementById("numerosorteio") as HTMLInputElement).value == '' ||
        ...
        for (let i = 0; i < this.vendedores.length; i++) {
          ...
          if (this.listanum[i] != null) {
            ...
            if (somacotas < 0) {
              ...
              this.cota.quantidadeCotaVendedor = this.listanum[i];
        ...
        this.bolao.qtdCotasDisponiveis = somacotas;
      ...
      if ((document.getElementById("numerosorteio") as HTMLInputElement).value == '' ||
        ...
        this.bolao.dataSorteio = new Date(this.bolao.dataSorteio.toString().substring(0, 4) + "-" + this.bolao.dataSorteio.toString().substring(5, 7) + "-" + this.bolao.dataSorteio.toString().substring(8));
        this.bolao.dataSorteio.setDate(this.bolao.dataSorteio.getDate() + 1);
